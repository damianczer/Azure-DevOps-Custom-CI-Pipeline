...
# Azure DevOps Custom CI Pipeline

*Inteligent build optimization for legacy .NET solutions*
...
```
Rebuilds EVERYTHING, even if you changed one CSS file!
...
```
Builds only changed projects + their dependencies!
